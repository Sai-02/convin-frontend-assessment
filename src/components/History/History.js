...
const History = () => {
  ...
  return (
    <div className="p-4">
      <h1 className="text-blue-700 font-semibold  text-xl">History</h1>
      <div className="p-4 grid gap-4">
        <div className="shadow grid grid-cols-4 overflow-hidden rounded-lg gap-4">
        ...
        {history.map((val, index) => {
          return (
            <div
              className="shadow grid grid-cols-4 overflow-hidden rounded-lg gap-4"
              key={index}
            >
